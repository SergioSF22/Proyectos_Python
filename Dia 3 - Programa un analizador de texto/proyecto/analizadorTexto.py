...
texto = input("Ingresa un texto de tu elección: ").lower()
...
print(f"Veces que aparece la letra '{letra1}' en tu texto: {texto.count(letras[0])}")
print(f"Veces que aparece la letra '{letra2}' en tu texto: {texto.count(letras[1])}")
print(f"Veces que aparece la letra '{letra3}' en tu texto: {texto.count(letras[2])}")

palabras = len(texto.split())
print("Palabras en tu texto: ", palabras)

print("Primera letra del texto: ", texto[0])
...
print("¿Se encuentra 'Python' en el texto?: ", comprobacion)